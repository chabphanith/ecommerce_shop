                    ...
                    <div class="container-fluid px-5">
                        <div class="row my-5">
                            ...
                            <div class="col-xl-6 col-md-6 mt-3 border border-primary p-3">
                                    ...
                                    <span class="text-dark"><strong>Name:</strong> Chab Phanith</span><br>
                                    <span class="text-dark"><strong>Email:</strong> chabphanith@gmail.com</span><br>
                            ...
                            <div class="col-xl-6 col-md-6 mt-3 border border-primary p-3">
                                    ...
                                    <span class="text-dark"><strong>Subtotal:</strong> $ 149</span><br>
                                    
                                    <h5 class="text-dark mt-3">Total: $ 149</h5>
